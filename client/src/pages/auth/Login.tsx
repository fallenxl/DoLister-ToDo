                ...
                <div className="flex flex-col justify-center w-full h-full lg:w-5/6 2xl:w-2/6 lg:h-4/6 shadow-md p-10 rounded-md bg-white">
                    ...
                    <form className="flex flex-col  w-full gap-5 text-[#8897AD]">
                        <div className="w-full ">
                            ...
                            <input name='email' type="text" placeholder="Example@email.com" className="border rounded-lg p-2 bg-[#F7FBFF] border-[#D4D7E3] w-full outline-none" />
                        </div>
                        <div className="w-full ">
                        ...
                        <Checkbox crossOrigin={undefined} label="Remember me" defaultChecked color="teal"/>
